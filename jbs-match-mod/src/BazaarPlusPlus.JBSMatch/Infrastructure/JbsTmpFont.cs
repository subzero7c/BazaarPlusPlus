...
internal static class JbsTmpFont
{
    ...
    private const string ResourceName = "BazaarPlusPlus.JBSMatch.Resources.Fonts.LXGWWenKai-Regular.ttf";
    ...
    {
        var cacheRoot = Path.Combine(GetCacheRoot(), "BazaarPlusPlus", "JBSMatch", "Fonts");
